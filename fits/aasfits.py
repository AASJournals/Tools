...
def main():
    """
    Main script for reviewing FITS tables with astropy.
    
    aasfits.py infile <options> 
    
    Parameters
    ----------
    infile : str, a FITS file
    options: 
    ...
    if len(sys.argv) < 2:
        print("")
        print("-------------------------------------------------------------------------------")
        print(" This toolkit is checking or converting a FITS table. ")
        print("")
        print(" > aasfits.py infile <options: csv|data|html|<none>>")
        print("")
        print(" options  ")
    ...
    data = Table.read(v, format="fits", hdu=1)

    print("")
    print("-------------------------------------------------------------------------------")
    print("aasfits.py checking...")
    print("")
    print("Type: ",p)
    print("File: ",v)
    print("Rows: ",len(data))
